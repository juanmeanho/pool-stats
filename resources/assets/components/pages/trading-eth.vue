    ...
    <div>
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-8">
                <!--======================== Formulario Comprar ===========================-->
                <b-card :header="'Comprar ' + (dataCoin.MarketCurrencyLong || '') + ' - Disponible [' + (balanceEth || 0) 
                                            + ' ' + (dataCoin.BaseCurrency || '') + '] - ($'+ toFix(balanceEth * usdBtcData.Last, 2)+')'" 
                        ...
                        <div class="card" style="width: 100%;">
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label >Cantidad {{  dataCoin.BaseCurrency }}</label> <span @click="setBtcSell" class="badge badge-success">  {{ balanceEth }}</span>
                                        <input type="numeric" @change="calculateOrderBuy(btcSell, priceBuy)" @keyup="calculateOrderBuy(btcSell, priceBuy)" 
    ...
    export default {
        ...
        data() {
            return {
                ...
                dataCoin: '', usdBtcData: '', instances: [], balances: 0, balanceEth: 0, balanceCoin: 0, getTotalCoinToBuy: 0, priceBuy: '', btcSell: '',
        ...
        methods: {
                    ...
                    .get(`/auth/api/getticker/${this.market}`)
                        ...
                        .then( data => { 
                            ...
                            //******************************************//
                                ...
                                let withoutFees = this.balanceEth / precioMejor
            ...
            getMarkets(){ //Trae los datos de las monedas
                ...
                .then(data => {
                    ...
                    this.dataCoin = data.getMarkets.result.filter(item => item.MarketCurrency == this.getNameCoin && item.BaseCurrency == 'ETH')[0]
            ...
            getBalance(){ //Trae el balance de todas las monedas
                axios
                    ...
                    .then(data => {
                        ...
                        //Saldo moneda base
                        let datosEth = data.getBalances.result.filter(item => item.Currency == this.dataCoin.BaseCurrency)

                        if(datosEth.length == 0)
                            this.balanceEth = 0
                        else
                            this.balanceEth = datosEth[0].Available
