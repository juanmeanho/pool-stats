                        ...
                        <v-scroll height="740px">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6">
                                    <div class="connection text-center row">
                                        <div class="connect-head">
                                            <img src="/images/avatar2.jpg" alt="User Image" class="rounded-circle">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="connection text-center row">
                                        <div class="connect-head">
                                            <img src="/images/avatar3.jpg" alt="User Image" class="rounded-circle">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="connection text-center row">
                                        <div class="connect-head">
                                            <img src="/images/avatar4.jpg" alt="User Image" class="rounded-circle">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="connection text-center row">
                                        <div class="connect-head">
                                            <img src="/images/avatar5.jpg" alt="User Image" class="rounded-circle">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="connection text-center row">
                                        <div class="connect-head">
                                            <img src="/images/avatar6.jpg" alt="User Image" class="rounded-circle">
                        ...
                        <div class="row" id="blog">
                            <div class="col-xl-4 col-lg-6">
                                <div class="blog-border">
                                    <div class="blog-heading">
                                        <p>
                                            <img src="/images/avatar6.jpg" alt="author image" class="blog-image rounded-circle p-2 float-left img-fluid">
                            ...
                            <div class="col-xl-4 col-lg-6">
                                ...
                                <div class="blog-border">
                                    <div class="blog-heading">
                                        <p>
                                            <img src="/images/avatar4.jpg" alt="author image" class="blog-image rounded-circle p-2 float-left">
