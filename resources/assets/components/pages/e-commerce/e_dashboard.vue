    ...
    <div>
        <div class="row">
            <div class="col-md-3 text-center">
                <b-card>
                    <div class="icon">
                        <img src="/images/icon-03.png" alt="sales icon">
                    </div>
                    <div class="number_font1">Sales</div>
                    <span class="arrow_up">
                        <img src="/images/Icons-10(1).png" alt="dollar image">
                    </span>
            ...
            <div class="col-md-3 text-center">
                <b-card>
                    <div class="icon">
                        <img src="/images/icon-02.png" alt="user image">
                    </div>
                    <div class="number_font1">Income</div>
                    <span class="arrow_up">
                        <img src="/images/Icons-10(1).png" alt="image up">
                    </span>
            ...
            <div class="col-md-3 text-center">
                <b-card>
                    ...
                    <span class="arrow_down text-danger">
                        <img src="/images/Icons_1-10.png" alt="image down">
                    </span>
            ...
            <div class="col-md-3 text-center">
                <b-card>
                    <div class="icon">
                        <img src="/images/icon-04.png" alt="product image">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <div class="text-center">
                                ...
                                <img src="/images/Icons-06 (3).png" class="img_move" alt="rounded circle">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <table class="table table-hover tot_boxline">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="tb_img">
                                            <img src="/images/e2.jpg" class="tb_img rounded-circle" alt="microwave image">
                                        </div>
                                    </td>
                                    <td>$3.20</td>
                                    <td>$ 10.23</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="tb_img">
                                            <img src="/images/e6.png" class="tb_img rounded-circle" alt="Mobile image">
                                        </div>
                                    </td>
                                    <td>$ 5.658</td>
                                    <td>$ 4.56</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="tb_img">
                                            <img src="/images/e5.png" class="tb_img rounded-circle" alt="image missing">
                                        </div>
                                    </td>
                                    <td>$ 7.89</td>
                                    <td>$ 8.982</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="tb_img">
                                            <img src="/images/900x600_2.png" class="tb_img rounded-circle" alt="image missing">
                                        </div>
                                    </td>
                                    <td>$ 7.89</td>
                                    <td>$ 9.58</td>
