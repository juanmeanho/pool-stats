                ...
                <div class="col-xl-12  mt-5">
                    <div class="row">
                        <a class="magnifier-thumb-wrapper mx-auto">
                            <img id="thumb" src="/images/polo.jpg" class="img-fluid" alt="Mobile image">
                        </a>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-12" v-for="(image,index) in thumbs" :key="index">
                            <b-btn  @click="openPictureModal(index)" class="mb-3 small_img">
                                <img src="/images/T-shirt.png" class="img-fluid slide-preview" alt="phone image">
                            </b-btn>
                            <!-- Modal Component -->
                            <b-modal title="Modal" ref="pictureModal">
                                <img src="/images/T-shirt.png" class="img-fluid" alt="small phone image missing">
                            </b-modal>
                        </div>
                    </div>
                </div>
