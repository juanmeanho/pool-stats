    ...
    <header class="header fixed-top">
        <nav>
            ...
            <div class="navbar-right">
                ...
                <!--drop downs-->
                <div>
                    <div class="dropdown hidden-xs-down btn-group mt-2" v-if="this.$store.state.calling">
                        <scale-loader style="text-align:right;" :loading="true" color="#5cb85c" height="25px" width="5px"></scale-loader>
                    </div>
                    <div v-else class="dropdown hidden-xs-down btn-group" >
                    ...
                    <b-dropdown class="user user-menu bell_bg user_btn" right link>
                        ...
                        <b-dropdown-item @click="logout" exact class="dropdown_content">
