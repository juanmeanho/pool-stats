            ...
            <div class="navbar-right">
                ...
                <div>
                            ...
                            <b-tabs>
                                <b-tab title="Notifications" class="tabs_cont" active>
                                    <b-dropdown-item exact>
                                        <div class="row">
                                            <div class="col-2 mt-2 ml-2">
                                                <img class="rounded-circle" src="/images/avatar1.jpg">
                                            </div>
                                    ...
                                    <b-dropdown-item exact>
                                        <div class="row">
                                            <div class="col-2 mt-2 ml-2">
                                                <img class="rounded-circle" src="/images/avatar5.jpg">
                                            </div>
                                            <div class="col-9 mt-2">
                                                <p> &nbsp;Lorem ipsum dolor sit amet, elit.
                                                    <br>
                                    ...
                                    <b-dropdown-item exact>
                                        <div class="row">
                                            <div class="col-2 mt-2 ml-2">
                                                <img class="rounded-circle" src="/images/avatar3.jpg">
                                            </div>
                                            <div class="col-9 mt-2">
                                                <p> &nbsp;Lorem ipsum dolor sit amet, elit.
                                                    <br>
                    ...
                    <b-dropdown class="user user-menu bell_bg user_btn" right link>
                        ...
                        <b-dropdown-item exact class="dropdown_content">
                            <router-link to="/login" @click="logout" exact class="drpodowtext">
